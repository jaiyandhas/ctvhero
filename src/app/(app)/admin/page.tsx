...
import { parseQuestions, ParsedQuestion } from '@/lib/questionParser'
...
interface QuestionCount { subject: string; count: number }
    ...
    useEffect(() => {
        const loadCounts = async () => {
            ...
            if (data) {
                ...
                data.forEach((r: { subject: string }) => { map[r.subject] = (map[r.subject] || 0) + 1 })
